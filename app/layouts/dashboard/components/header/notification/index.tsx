...
export const Notification = () => {
  return (
    <div className="group relative hidden cursor-pointer place-self-center md:block">
      <span className="absolute -right-1.5 -top-1.5 h-5 w-5 content-center rounded-full bg-danger text-center text-xxs font-semibold text-white shadow group-hover:scale-105">
        12
      </span>
